...
<div class="admin-content-container">
    <h2 class="text-center text-uppercase pt-5">Add New Product</h2>
    <form id="createProduct" class="add-post-form row" method="post" enctype="multipart/form-data">
        <div class="col-md-9">
            ...
            <div class="form-group brand">
                ...
                <select class="form-control product_brands" name="product_brand">
                    <option value="" selected disabled> Select Brand Category</option>
                    <?php if ($categories > 0) {
                        foreach ($categories as $category) { ?>
                            <option value="<?php echo $category['cat_id']; ?>"><?php echo $category['cat_title']; ?></option>
                    <?php }
        ...
        <div class="col-md-3">
            ...
            <div class="form-group">
                <input id="createProduct" type="submit" class="btn btn-primary add-new mt-3" name="submit" value="Add Product">
            </div>
        </div>
    </form>
</div>

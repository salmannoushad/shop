...
// include header file
include 'header.php'; ?>
<div class="admin-content-container" style="height: 75vh">
    <h3 class="text-center text-uppercase pt-5">update category</h3>
    <?php
    $cat_id = $_GET['id'];
    $db = new Database();
        ...
        foreach ($result as $row) { ?>
            <div class="row">
                ...
                <form id="updateCategory" class="add-post-form col-md-6" method="POST">
                    ...
                    <input type="submit" name="sumbit" class="btn btn-primary mt-2" value="Update" />
                </form>
                <!-- /Form -->
            </div>
        <?php

<?php
	...
	if(isset($_POST['login'])){
		if(!isset($_POST['username']) || empty($_POST['username'])){
			...
			$db->select('user','user_id,f_name,l_name,username',null,"username = '{$username}' AND password = '{$password}'",null,null);
			$response = $db->getResult();
			if(!empty($response)){
				...
				echo json_encode(array('error'=>'Not Set Username and Password not matched.')); exit;
			}
		}
	}
